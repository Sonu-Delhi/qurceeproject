...
const UploadPortfolio = ({ onClose, fetchData }) => {
    const [data, setData] = useState({
      ...
      const handleUploadProduct = async (e) => {
        ...
        setData((preve) => {
          return {
            ...preve,
            logoImage: [...preve.logoImage, uploadImageCloudinary.url],
          };
        });
      };
      ...
      const handleSubmit = async (e) => {
        ...
        const response = await fetch(SummaryApi.addClients.url, {
          method: SummaryApi.addClients.method,
          credentials: "include",
          headers: {
  ...
  return (
    <div className="fixed w-full mt-16 -z-0  h-full bg-slate-200 bg-opacity-35 top-0 left-0 right-0 bottom-0 flex justify-center items-center">
